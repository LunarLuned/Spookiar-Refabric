...
public class GhostModel<T extends Ghost> extends HierarchicalModel<T> {
    ...
    public void setupAnim(T ghost, float angle, float distance, float animationProgress, float yaw, float pitch) {
        ...
        this.animate(ghost.walkAnimationState, GhostAnimations.GHOST_WALK, animationProgress, k);
        this.animate(ghost.fallAnimationState, GhostAnimations.GHOST_FALL, animationProgress);
        this.animate(ghost.hurtAnimationState, GhostAnimations.GHOST_HURT, animationProgress);
    }
}
