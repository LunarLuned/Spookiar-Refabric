...
// The Prime Spirit's translucent outer layer  renderer
...
public class PrimeSpiritOuterLayerRenderer<T extends PrimeSpirit, M extends PrimeSpiritModel<T>> extends RenderLayer<T, M> {

    private static final RenderType PRIME_SPIRIT = RenderType.entityTranslucentEmissive(new ResourceLocation(Spookiar.MOD_ID, "textures/entity/prime_spirit/prime_spirit_outer.png"));
    private static final RenderType PRIME_SPIRIT_ANGERED = RenderType.entityTranslucentEmissive(new ResourceLocation(Spookiar.MOD_ID, "textures/entity/prime_spirit/prime_spirit_outer_angered.png"));

	public PrimeSpiritOuterLayerRenderer(RenderLayerParent<T, M> featureRendererContext) {
