...
import net.lunarluned.spookiar.client.render.projectiles.GrimsteelDaggerRenderer;
...
public class ModEntityRenderer {
	...
	public static final ModelLayerLocation GRIMSTEEL_DAGGER = new ModelLayerLocation(new ResourceLocation(Spookiar.MOD_ID, "grimsteel_dagger"), "main");


	public static void registerRenderers() {
		EntityRendererRegistry.register(ModEntities.GRIMSTEEL_DAGGER, GrimsteelDaggerRenderer::new);
		...
		EntityModelLayerRegistry.registerModelLayer(GRIMSTEEL_DAGGER, GrimsteelDaggerModel::createBodyLayer);
